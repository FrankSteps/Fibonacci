...
//código base
float result(float oper1, char simbol, float oper2;){
  //Função que retorna um valor float de uma operação em específico
  return result;
}

void showTV(){
  //função para mostrar o resultado da operação na TV entre outras configurações
}
